...
| 4   | Secret isolation + quality-gates wiring + north-star e2e | Lock the floor: key-isolation check, CI gates, one e2e of the full co-care flow incl. the conflict warning | #6, cross-cutting  | static check + gates + e2e | complete | context/archive/2026-06-10-testing-secret-isolation-gates-e2e/ |
